...
export const Testimonials = () => {
  ...
  return (
    <section id="testimonials" className="py-24 bg-gradient-to-br from-slate-900 via-blue-900 to-indigo-900 text-white overflow-hidden relative">
      {/* Decorative Elements */}
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        >
          <motion.span
            ...
            viewport={{ once: true }}
            className="inline-block bg-white/10 backdrop-blur-sm text-white px-4 py-2 rounded-full text-sm font-semibold mb-4"
          >
            Témoignages
          </motion.span>
            ...
            <AnimatePresence mode="popLayout">
              {visibleTestimonials.map((testimonial, idx) => (
                <motion.div
                  ...
                  className={`bg-white/10 backdrop-blur-lg rounded-2xl p-8 border border-white/20 transition-all ${
                    idx === 1 ? 'md:scale-105 shadow-2xl' : 'hidden md:block'
                  }`}
                >
                  {/* Quote Icon */}
                  <div className="mb-4">
                    <Quote className="w-10 h-10 text-blue-300 opacity-50" />
                  </div>
                  ...
                  {/* Content */}
                  <p className="text-lg mb-6 leading-relaxed italic text-blue-50">
                    "{testimonial.content}"
                  </p>
