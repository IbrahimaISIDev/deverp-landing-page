...
export const Hero = () => {
  ...
  return (
    <section ref={targetRef} className="relative pt-24 md:pt-32 pb-12 md:pb-20 overflow-hidden min-h-[90vh] md:min-h-screen flex items-center">
      ...
      >
        ...
        <motion.div
          ...
          className="inline-flex items-center gap-2 bg-blue-100/80 backdrop-blur-sm text-blue-700 px-4 md:px-6 py-2 rounded-full mb-6 md:mb-8 border border-blue-200/50 text-xs md:text-sm"
        >
          <Sparkles className="w-3 h-3 md:w-4 md:h-4" />
          <span className="font-semibold">La solution ERP nouvelle génération</span>
        </motion.div>
        ...
        <motion.h1
          ...
          className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-extrabold text-slate-900 leading-tight mb-4 md:mb-6 tracking-tight px-4"
        >
        ...
        <motion.p
          ...
          className="text-base sm:text-lg md:text-xl lg:text-2xl text-slate-600 mt-4 md:mt-6 max-w-3xl mx-auto leading-relaxed px-4"
        >
        ...
        <motion.div
          ...
          className="flex flex-wrap items-center justify-center gap-3 md:gap-6 mt-6 md:mt-8 text-xs md:text-sm text-slate-600 px-4"
        >
          ...
          <div className="flex items-center gap-1.5 md:gap-2">
            <Zap className="w-3 h-3 md:w-4 md:h-4 text-yellow-600" />
        ...
        >
          <motion.a
            ...
            whileTap={{ scale: 0.95 }}
            className="group bg-gradient-to-r from-blue-600 to-indigo-600 text-white rounded-full px-6 sm:px-8 md:px-10 py-3 md:py-4 hover:shadow-2xl hover:shadow-blue-500/40 transition-all font-bold text-base md:text-lg flex items-center justify-center gap-2"
          >
            Demander une démo
          ...
          <motion.a
            ...
            whileHover={{ scale: 1.05, y: -2 }}
            whileTap={{ scale: 0.95 }}
            className="bg-white text-slate-800 rounded-full px-6 sm:px-8 md:px-10 py-3 md:py-4 hover:shadow-xl transition-all font-semibold text-base md:text-lg border-2 border-slate-200"
          >
        ...
        <motion.div
          ...
          className="grid grid-cols-3 gap-4 md:gap-8 max-w-3xl mx-auto mt-12 md:mt-20 pt-8 md:pt-12 border-t border-slate-200 px-4"
        >
          <div>
            <div className="text-2xl sm:text-3xl md:text-4xl font-bold bg-gradient-to-r from-blue-600 to-indigo-600 bg-clip-text text-transparent">50+</div>
            <div className="text-slate-600 mt-1 md:mt-2 text-xs sm:text-sm md:text-base">Établissements</div>
          </div>
          <div>
            <div className="text-2xl sm:text-3xl md:text-4xl font-bold bg-gradient-to-r from-blue-600 to-indigo-600 bg-clip-text text-transparent">15k+</div>
            <div className="text-slate-600 mt-1 md:mt-2 text-xs sm:text-sm md:text-base">Étudiants</div>
          </div>
          <div>
            <div className="text-2xl sm:text-3xl md:text-4xl font-bold bg-gradient-to-r from-blue-600 to-indigo-600 bg-clip-text text-transparent">99%</div>
            <div className="text-slate-600 mt-1 md:mt-2 text-xs sm:text-sm md:text-base">Satisfaction</div>
          </div>
        </motion.div>
      </motion.div>
    </section>
