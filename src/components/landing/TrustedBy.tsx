      ...
      <div className="container mx-auto px-6">
        ...
        <div className="relative overflow-hidden">
          <div className="flex gap-8 animate-scroll">
            {[...partners, ...partners].map((partner, index) => (
              ...
              >
                <div className="bg-gradient-to-br from-slate-50 to-slate-100 rounded-2xl p-8 shadow-md hover:shadow-xl transition-all border border-slate-200 hover:border-blue-300 min-w-[200px]">
                  <div className="flex flex-col items-center gap-3">
                    <partner.icon className="w-10 h-10 text-slate-400 group-hover:text-blue-600 transition-colors" />
                    <p className="text-xs font-medium text-slate-600 text-center leading-tight">
                      {partner.name}
                    </p>
                  </div>
                </div>
        ...
        >
          <div className="text-center">
            ...
            <p className="text-slate-600 text-sm">Établissements partenaires</p>
          </div>
          <div className="text-center">
            <motion.div
              initial={{ scale: 0 }}
          ...
          <div className="text-center">
            ...
            <p className="text-slate-600 text-sm">Taux de satisfaction</p>
          </div>
          <div className="text-center">
            <motion.div
              initial={{ scale: 0 }}
            ...
            <p className="text-slate-600 text-sm">Support disponible</p>
          </div>
        </motion.div>
      </div>
